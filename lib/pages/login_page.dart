...
import 'package:flutter_app/const/gradient_const.dart';
import 'package:flutter_app/const/styles.dart';
...
//              color: Color(0xff35AA90), size: 1This application cannot tree shake icons fonts. It has non-constant instances of IconData at the following locations:0.0),
          contentPadding: new EdgeInsets.fromLTRB(40.0, 30.0, 10.0, 10.0),
          border: OutlineInputBorder(
              borderRadius: new BorderRadius.circular(12.0),
              borderSide: BorderSide.none),
          hintText: 'MpbilePhone',
          hintStyle: hintAndValueStyle),
    ),
  );
}
